 ...
 */
@Mod(modid=CommBind.MODID, name=CommBind.MODNAME, clientSideOnly=true, guiFactory="the_fireplace.commbind.config.CommBindGuiFactory", updateJSON = "http://caterpillar.bitnamiapp.com/jsons/commbind.json", acceptedMinecraftVersions = "[1.9.4,1.10.2]")
